    ...
    for row in csv_reader:
        if line_count <= 0:
            ...
            try:
                ...
                main_div = browser.find_element_by_xpath('//*[@id="fl-main-content"]/div[1]/div[1]/div/div/div/div[1]/div/div[2]/div')

                

                try:
                    website = main_div.find_element_by_xpath('//*[@id="fl-main-content"]/div[1]/div[3]/div/div/div/div[1]/div/div[2]/div/div/a[2]').text
                except:
                    website = "website"
