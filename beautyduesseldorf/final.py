    ...
    for row in csv_reader:
        if line_count <= 0:
            ...
            try:
                ...
                #main_div = browser.find_element_by_xpath('//*[@id="vis__profile"]/div[2]/div/div/div/div[1]')

                #pdb.set_trace()
                
                
                try:
                    address = browser.find_element_by_xpath('//*[@id="vis__profile"]/div[2]/div/div/div/div[1]/div[1]').text.replace('\n',' ')
                except:
                    address = "address"
                ...
                try:
                    website = browser.find_element_by_xpath('//*[@id="vis__profile"]/div[2]/div/div/div/div[1]/div[2]/ul/li/a').text
                except:
                    website = "website"
