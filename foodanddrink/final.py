...
browser.execute_script('''window.open("https://s3-eu-west-1.amazonaws.com/livebuzz-web-modules/releases/v1-latest-prod/index.html#/?web-module-id=fde-exhibitors&campaign=food-shows-2021&organization=wrbm&web-module-pathname=%2Fexhibitors%2F","_blank");''')
